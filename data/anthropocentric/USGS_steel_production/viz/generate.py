...
data = pd.read_csv('../processed/USGS_steel_production_1994-2021.csv')
...
chart = alt.Chart(proc_data).encode(
            ...
            y=alt.Y(field='production', type='quantitative', title='Steel production (Mt)', scale=alt.Scale(zero=False)),
