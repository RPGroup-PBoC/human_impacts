...
proc_data['Antarctic mass (Gt)'] = data['Antarctic Mass Gt']
proc_data['lower bound'] = proc_data['Antarctic mass (Gt)']-data['Antarctic Mass Gt (1-sigma uncertainty)']
proc_data['upper bound'] = proc_data['Antarctic mass (Gt)']+data['Antarctic Mass Gt (1-sigma uncertainty)']
...
chart = alt.Chart(proc_data).encode(
            ...
            y=alt.Y(field='Antarctic mass (Gt)', type='quantitative', title='Antarctic mass [Gt]', scale=alt.Scale(domain=[-3000, 200])),
            tooltip=[alt.Tooltip(field='yyyy-mm-dd', type='temporal', title='date', format='%Y-%b-%d'),
                     alt.Tooltip(field='Antarctic mass (Gt)', type='quantitative', title='mass change (Gt)')]
...
layer.save('./Antarctic_mass_loss.json')
# %%
