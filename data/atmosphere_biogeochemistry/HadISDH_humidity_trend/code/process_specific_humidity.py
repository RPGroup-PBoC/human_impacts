...
# with the processed time series. The data provided are specific humidity anomalies
# with respect to a 1981-2010 reference in g/kg. Uncertainty estimates are 2 sigma.

# The original data file contains 10 columns:
# Column 1 is the date in year.decimal format.
# Column 2 is the specific humidity anomaly.
...
proc_data = pd.read_csv('../source/HadISDH.blendq.1.0.0.2019fSHIP_global_annual_full_anoms8110_JAN2020.dat',
