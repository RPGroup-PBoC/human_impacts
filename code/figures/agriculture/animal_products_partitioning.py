...
production = production[(production['year'] >= 2010)]
...
# %%
# Total product. 
total = pd.read_csv('../../../data/agriculture/FAOSTAT_livestock_product_produced/processed/FAOSTAT_aggregated_livestock_product_categorized.csv')
